...
To perform the analysis properly, a new column, named Profit/Loss was introduced by use of IF Function to categorise the values in the Profit Column as Either Profit for all values greater than 0 or as Loss for all values less 0. Therefore, the final data had 21 Variables and 9994 observations. The final workbook contained worksheets named: State, Ctegory, SubCategory, City, Region, Sales and CoGS, Profit and Sales. The Excel Workbook is named "Superstore.xlsx".
